      ...
      <div className="section-padding">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-white/70 text-sm">Follow on Instagram</span>
                </div>
            ...
            {/* Navigation */}
            <div>
              <h4 className="font-medium text-sm tracking-wide uppercase mb-6">Navigation</h4>
              <nav className="space-y-3">
                ...
                <a href="/contact" className="block text-white/70 hover:text-white transition-colors duration-300">
                  Contact
                </a>
              </nav>
            </div>
